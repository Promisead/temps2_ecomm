          ...
          <div class="container">
            <div class="header__logo">
              <div class="header__logo-btn" data-dropdown-btn="logo">
                RoxxOptions<i class="icon-Arrow_Below"></i>
              </div>
              <nav
                class="dropdown dropdown--design-01"
                data-dropdown-list="logo"
              >
                <ul class="dropdown__catalog">
                  ...
                  <li>
                    <a href="single-topic.html">Single Topic Page</a>
                  </li>
                  <li>
                    <a href="simple-signup.html">Sign up Page</a>
                  </li>
                  <li>
                    <a href="create-topic.html">Create Topic Page</a>
                  </li>
                </ul>
              </nav>
            </div>
                  ...
                  <ul class="dropdown__catalog row">
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-f9bc64"></i>Hobbies
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-348aa7"></i>Social
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-4436f8"></i>Video
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-5dd39e"></i>Random
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-ff755a"></i>Arts
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-bce784"></i>Tech
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-83253f"></i>Gaming
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-c49bbb"></i>Science
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-3ebafa"></i>Exchange
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-c6b38e"></i>Pets
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-a7cdbd"></i>Entertainment
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-525252"></i>Education
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-777da7"></i>Q&amp;As
                      </a>
                    </li>
                    <li class="col-xs-6">
                      <a href="#" class="category">
                        <i class="bg-368f8b"></i>Politics
                      </a>
                    </li>
                  </ul>
                </div>
              ...
              >
                <div>
                  ...
                  <a href="#">
                    ...
                    <p>
                      Callis . 18 feb, 17<span>I got an amzon thingie!</span>
                    </p>
                  </a>
                  <a href="#">
                  ...
                  <a href="#">
                    ...
                    <p>
                      Charlie . 22 feb, 17
                      <span>Need Video file of that cat.</span>
                    </p>
                  </a>
                  <a href="#">
                    ...
                    <p>
                      Greentea . 22 feb, 17
                      <span>New Facebook like and share button.</span>
                    </p>
                  </a>
                  <span>
        ...
        <div class="container">
          <div class="nav">
            <div class="nav__categories js-dropdown">
              ...
              <div class="nav__select">
                <div class="btn-select" data-dropdown-btn="tags">
                  Tags
                </div>
                <div
                  class="dropdown dropdown--design-01"
                ...
                >
                  <div class="tags">
                    ...
                    <a href="#" class="bg-f26522">
                      photography
                    </a>
                    <a href="#" class="bg-a3d39c">
                      climbing
                    </a>
                    <a href="#" class="bg-92278f">
                      adventure
                    </a>
                    <a href="#" class="bg-8781bd">
                      dreams
                    </a>
                    <a href="#" class="bg-f1ab32">
                      life
                    </a>
                    <a href="#" class="bg-3b96ca">
                      reason
                    </a>
                    <a href="#" class="bg-348aa7">
                      social
                    </a>
                  </div>
                </div>
            ...
            <div class="nav__menu js-dropdown">
              <div class="nav__select">
                <div class="btn-select" data-dropdown-btn="menu">
                  Latest
                </div>
                <div
                  class="dropdown dropdown--design-01"
                    ...
                    <div>
                      ...
                      >
                        <div class="dropdown__user">
                          <a href="#" class="dropdown__user-label bg-218380">
                            B
                          </a>
              ...
              <div class="posts__item">
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    ...
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/G.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/P.svg" alt="avatar" />
                      </a>
                    </div>
                  </div>
              ...
              <div class="posts__item bg-f2f4f6">
                <div class="posts__section-left">
                  <div class="posts__topic">
                    <div class="posts__content">
                      <a href="#">
                        <h3>
                          Get your username drawn by the other users of
                          RoxxOptions! or a drawing based on what you do
                        </h3>
                      </a>
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/L.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/T.svg" alt="avatar" />
                      </a>
                    </div>
                  </div>
              ...
              <div class="posts__item">
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/E.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/I.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/R.svg" alt="avatar" />
                      </a>
                    </div>
                  </div>
              ...
              <div class="posts__item posts__item--bg-gradient">
                <div class="posts__section-left">
                  <div class="posts__topic">
                    <div class="posts__content">
                      <a href="#">
                        <h3>
                          <span>This post contails spoiler about</span> Star
                          Wars Movie.
                        </h3>
                      </a>
                    </div>
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/F.svg" alt="avatar" />
                      </a>
                    </div>
                  </div>
              ...
              <div class="posts__item">
                <div class="posts__section-left">
                  <div class="posts__topic">
                    <div class="posts__content">
                      <a href="#">
                        <h3>
                          Take a picture of what you’re doing at this very
                          moment
                        </h3>
                      </a>
                      <div class="posts__tags tags">
                        <a href="#" class="bg-ec008c">
                          selfie
                        </a>
                        <a href="#" class="bg-7cc576">
                          camera
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/C.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/U.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
              ...
              <div class="posts__item bg-f2f4f6">
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    ...
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/Q.svg" alt="avatar" />
                      </a>
                    </div>
                  </div>
              ...
              <div class="posts__item">
                <div class="posts__section-left">
                  <div class="posts__topic">
                    <div class="posts__content">
                      <a href="#">
                        <h3>
                          <i class="icon-Locked"></i>I got an Amazon thingie!
                        </h3>
                      </a>
                    </div>
                  </div>
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    ...
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/W.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/Y.svg" alt="avatar" />
                      </a>
                    </div>
                  </div>
              ...
              <div class="posts__item bg-f2f4f6">
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/D.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/M.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
                ...
                <div class="posts__section-right">
                  <div class="posts__users js-dropdown">
                    ...
                    <div>
                      ...
                      <div
                        class="posts__users-dropdown dropdown dropdown--user dropdown--open"
                        data-dropdown-list="user-t"
                      >
                        <div class="dropdown__user">
                          <a href="#" class="dropdown__user-label bg-00bd9d">
                            T
                          </a>
                          <div class="dropdown__user-nav">
                            <a href="#">
              ...
              <div class="posts__item bg-f2f4f6">
                <div class="posts__section-left">
                  <div class="posts__topic">
                    <div class="posts__content">
                      <a href="#">
                        <h3>
                          GAMERS UNITE! What games do the RoxxOptions Community
                          play?
                        </h3>
                      </a>
                    </div>
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/H.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
              ...
              <div class="posts__item bg-f2f4f6">
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    ...
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/S.svg" alt="avatar" />
                      </a>
                    </div>
                  </div>
              ...
              <div class="posts__item bg-f2f4f6">
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/J.svg" alt="avatar" />
                      </a>
                    </div>
                    <div>
                      <a href="#" class="avatar">
              ...
              <div class="posts__item">
                ...
                <div class="posts__section-right">
                  <div class="posts__users">
                    ...
                    <div>
                      <a href="#" class="avatar">
                        <img src="fonts/icons/avatars/Z.svg" alt="avatar" />
                      </a>
                    </div>
                  </div>
            ...
            <div class="footer__nav">
              <div class="footer__tline">
                ...
                <div class="footer__language">
                  ...
                  >
                    Americas - English<i class="icon-Arrow_Below"></i>
                  </div>
                  <div
                    class="footer__language-dropdown dropdown dropdown--design-01 dropdown--reverse-y"
              ...
              <div class="footer__bline">
                <ul class="footer__menu">
                  <li class="footer__copyright">
                    <span>
                      &copy; All Rights Reserved by <a href="#">roxxoptions</a>
                    </span>
                  </li>
                  <li>
                    <a href="#">Teams</a>
